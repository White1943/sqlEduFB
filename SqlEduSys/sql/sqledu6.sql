...
-- ----------------------------
INSERT INTO `nl_queries` VALUES ('1', '查询所有管理员用户的信息，包括用户名、电子邮件和创建日期', 'sers', '4', 'pending', null, '2025-02-03 15:27:31', '2025-02-03 15:27:31');
INSERT INTO `nl_queries` VALUES ('2', '查找在过去一个月内登录过的所有活跃用户', 'sers', '4', 'pending', null, '2025-02-03 15:27:31', '2025-02-03 15:27:31');
INSERT INTO `nl_queries` VALUES ('3', '统计每个用户的最后一次登录时间，并按最后一次登录时间降序排列', 'sers', '4', 'pending', null, '2025-02-03 15:27:31', '2025-02-03 15:27:31');
INSERT INTO `nl_queries` VALUES ('4', '获取所有非管理员用户的用户名和电子邮件，并按用户名升序排列', 'sers', '4', 'pending', null, '2025-02-03 15:27:31', '2025-02-03 15:27:31');
INSERT INTO `nl_queries` VALUES ('5', '查找所有从未登录过的用户，并显示他们的用户名和注册日期', 'sers', '4', 'pending', null, '2025-02-03 15:27:31', '2025-02-03 15:27:31');
INSERT INTO `nl_queries` VALUES ('6', '统计每个注册月份的用户数量，并按月份排序', 'sers', '4', 'pending', null, '2025-02-03 15:27:31', '2025-02-03 15:27:31');
INSERT INTO `nl_queries` VALUES ('7', '查询所有在2025年1月19日之前创建的用户，并显示他们的用户名和创建日期', 'sers', '4', 'pending', null, '2025-02-03 15:27:31', '2025-02-03 15:27:31');
INSERT INTO `nl_queries` VALUES ('8', '更新所有非管理员用户的`is_active`状态为0，并返回受影响的行数', 'sers', '4', 'pending', null, '2025-02-03 15:27:31', '2025-02-03 15:27:31');
INSERT INTO `nl_queries` VALUES ('9', '查找所有电子邮件地址包含“qq.com”的用户，并显示他们的用户名和电子邮件', 'sers', '4', 'pending', null, '2025-02-03 15:27:31', '2025-02-03 15:27:31');
INSERT INTO `nl_queries` VALUES ('10', '统计所有用户的平均注册时长（从创建日期到当前日期），并以天为单位显示结果', 'sers', '4', 'pending', null, '2025-02-03 15:27:31', '2025-02-03 15:27:31');
INSERT INTO `nl_queries` VALUES ('21', '查询所有管理员用户的详细信息', 'users', '4,5', 'pending', null, '2025-02-04 01:58:33', '2025-02-04 01:58:33');
INSERT INTO `nl_queries` VALUES ('22', '统计每个用户自注册以来的登录次数，并按登录次数降序排列', 'users', '4,5', 'pending', null, '2025-02-04 01:58:33', '2025-02-04 01:58:33');
INSERT INTO `nl_queries` VALUES ('23', '查找最近一周内没有登录过的活跃用户', 'users', '4,5', 'pending', null, '2025-02-04 01:58:33', '2025-02-04 01:58:33');
INSERT INTO `nl_queries` VALUES ('24', '更新所有非管理员用户的 `is_active` 状态为0，因为他们长时间未登录', 'users', '4,5', 'pending', null, '2025-02-04 01:58:33', '2025-02-04 01:58:33');
INSERT INTO `nl_queries` VALUES ('25', '获取当前数据库版本号以及所有用户的数量', 'alembic_version,users', '4,5', 'pending', null, '2025-02-04 01:58:33', '2025-02-04 01:58:33');
INSERT INTO `nl_queries` VALUES ('26', '查找用户名中包含“test”的所有用户，并显示他们的注册日期', 'users', '4,5', 'approved', '根据提供的数据库Schema和自然语言查询需求，以下是生成的SQL语句：\n\n```sql\nSELECT username, date_created\nFROM users\nWHERE username LIKE \'%test%\';\n```\n\n这条SQL语句会查找 `users` 表中用户名 (`username`) 包含 \"test\" 的所有用户，并显示他们的注册日期 (`date_created`)。 `%test%` 是一个通配符表达式，表示任意位置包含 \"test\" 的字符串。', '2025-02-04 01:58:33', '2025-02-04 03:28:43');
INSERT INTO `nl_queries` VALUES ('27', '统计每个小时段内用户注册的数量，以分析一天中哪个时间段注册人数最多', 'users', '4,5', 'pending', null, '2025-02-04 01:58:33', '2025-02-04 01:58:33');
INSERT INTO `nl_queries` VALUES ('28', '查询所有在过去24小时内注册的用户，并按注册时间升序排列', 'users', '4,5', 'pending', null, '2025-02-04 01:58:33', '2025-02-04 01:58:33');
INSERT INTO `nl_queries` VALUES ('29', '找出所有从未登录过的用户，并标记他们为不活跃用户（更新 `is_active` 为0）', 'users', '4,5', 'pending', null, '2025-02-04 01:58:33', '2025-02-04 01:58:33');
INSERT INTO `nl_queries` VALUES ('30', '按月统计新注册用户的数量，并显示每个月的新用户增长趋势', 'users', '4,5', 'pending', null, '2025-02-04 01:58:33', '2025-02-04 01:58:33');
INSERT INTO `nl_queries` VALUES ('31', '查找在过去一个月内活跃的用户及其聊天记录数量', 'users,chat_history', '7', 'approved', '要查找在过去一个月内活跃的用户及其聊天记录数量，我们需要从 `users` 表和 `chat_history` 表中提取相关信息。具体来说，我们需要：\n\n1. 筛选出在过去一个月内有聊天记录的用户。\n2. 统计每个用户的聊天记录数量。\n\n以下是满足这些需求的 SQL 查询：\n\n```sql\nSELECT \n    u.id AS user_id,\n    u.username,\n    COUNT(ch.id) AS chat_count\nFROM \n    users u\nJOIN \n    chat_history ch ON u.id = ch.user_id\nWHERE \n    ch.created_at >= DATE_SUB(CURRENT_DATE, INTERVAL 1 MONTH)\nGROUP BY \n    u.id, u.username\nORDER BY \n    chat_count DESC;\n```\n\n### 解释：\n- **`JOIN`**: 我们使用 `JOIN` 将 `users` 表和 `chat_history` 表连接在一起，基于 `user_id` 字段。\n- **`WHERE`**: 使用 `DATE_SUB(CURRENT_DATE, INTERVAL 1 MONTH)` 来筛选出过去一个月内的聊天记录。\n- **`GROUP BY`**: 按照用户 ID 和用户名分组，以便统计每个用户的聊天记录数量。\n- **`COUNT(ch.id)`**: 统计每个用户的聊天记录数量。\n- **`ORDER BY chat_count DESC`**: 按照聊天记录数量降序排列结果。\n\n这个查询将返回在过去一个月内活跃的用户及其对应的聊天记录数量。', '2025-02-11 11:46:42', '2025-02-11 11:48:02');
INSERT INTO `nl_queries` VALUES ('32', '列出所有当前激活的语言模型及其描述', 'llm_models', '7', 'pending', null, '2025-02-11 11:46:42', '2025-02-11 11:46:42');
INSERT INTO `nl_queries` VALUES ('33', '统计每个状态（pending, approved, rejected）的自然语言查询数量', 'nl_queries', '7', 'pending', null, '2025-02-11 11:46:42', '2025-02-11 11:46:42');
INSERT INTO `nl_queries` VALUES ('34', '找出每个用户的最新一次聊天记录，并显示该记录的时间和内容', 'users,chat_history', '7', 'pending', null, '2025-02-11 11:46:42', '2025-02-11 11:46:42');
INSERT INTO `nl_queries` VALUES ('35', '查询在2025年1月创建的所有SQL文件及其内容', 'sqls', '7', 'pending', null, '2025-02-11 11:46:42', '2025-02-11 11:46:42');
INSERT INTO `nl_queries` VALUES ('36', '查找使用特定语言模型进行聊天的用户及其聊天内容', 'users,chat_history,llm_models', '7', 'pending', null, '2025-02-11 11:46:42', '2025-02-11 11:46:42');
INSERT INTO `nl_queries` VALUES ('37', '找出所有已批准的自然语言查询及其生成的SQL语句', 'nl_queries,sqls', '7', 'pending', null, '2025-02-11 11:46:42', '2025-02-11 11:46:42');
INSERT INTO `nl_queries` VALUES ('38', '列出所有管理员用户及其最后一次登录时间', 'users', '7', 'pending', null, '2025-02-11 11:46:42', '2025-02-11 11:46:42');
INSERT INTO `nl_queries` VALUES ('39', '统计每个语言模型在过去一周内的使用次数', 'chat_history,llm_models', '7', 'pending', null, '2025-02-11 11:46:42', '2025-02-11 11:46:42');
INSERT INTO `nl_queries` VALUES ('40', '获取数据库的最新版本号以及对应的更新时间', 'alembic_version', '7', 'pending', null, '2025-02-11 11:46:42', '2025-02-11 11:46:42');
